...
public class PharmacyMainPanel extends javax.swing.JPanel {
    ...
    public PharmacyMainPanel(String username, PharmacySupplyInfo pharmSuppData) {
        initComponents();
    ...
    private void lblUserCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblUserCreateMouseClicked
        ...
        PharmacyOrdersListPanel pvo = new PharmacyOrdersListPanel(username, pharmSuppData);
        jSplitPane1.setRightComponent(pvo);
    ...
    private void UserViewlblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UserViewlblMouseClicked
        // TODO add your handling code here:
        RestockPharmacyPanel rrp = new RestockPharmacyPanel(username, pharmSuppData);
        jSplitPane1.setRightComponent(rrp);
