...
public class PatientAppointmentBookingPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PatientAppointmentBookingPanel
     */
    DoctorInfo docData;
    EncounterInfo encData;
    String username;
    public PatientAppointmentBookingPanel(String username) {
        initComponents();
...
private void populateTable() {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            InsurancePolicyInfo x = new InsurancePolicyInfo();
            InsurancePolicy y = x.addNewInsurPolicy();
            y.setPatientUsername(pat);
            y.setInsuranceAgencyId(String.valueOf(insId));
            x.createInsurPolicyInDb(y);
            jTextField2.setText("");
