...
public class MediconnectLoginPanel extends javax.swing.JFrame {

    /**
     * Creates new form MediconnectLoginPanel
     */
    UserInfo userData;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("WELCOME TO MEDICONNECT ");
        ...
        jButton1.setBackground(new java.awt.Color(171, 199, 198));
        ...
        jPanel3.setBackground(new java.awt.Color(171, 199, 198));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("Vader".equals(txtUsername.getText()) & "Padme".equals(password)) {
            ...
            AdminWorkAreaPanel sap = new AdminWorkAreaPanel(userData, hosData, pharmData, suppData);
...
//                stmt.executeUpdate(query);
                ...
                if (rst.next()) {
                    ...
                    //JOptionPane.showMessageDialog(this, "MediconnectLoginPanel Sucess", "", HEIGHT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MediconnectLoginPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MediconnectLoginPanel().setVisible(true);
            }
        });
    }
