...
public class PharmacyManagerAdminPanel extends javax.swing.JPanel {

    /**
     * Creates new form PharmacyManagerAdminPanel
     */
    UserInfo userData;
    ...
    public PharmacyManagerAdminPanel(UserInfo userData, HospitalInfo hosData, SupplierInfo suppData, pharmacyInfo pharmData) {
        initComponents();
    ...
    private void lblUserCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblUserCreateMouseClicked
        ...
        PharmacyRegistrationPanel rp = new PharmacyRegistrationPanel();
    ...
    private void UserViewlblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UserViewlblMouseClicked
        // TODO add your handling code here:
        PharmacyDetailsAdminPanel vpa = new PharmacyDetailsAdminPanel(pharmData);
        jSplitPane1.setRightComponent(vpa);
