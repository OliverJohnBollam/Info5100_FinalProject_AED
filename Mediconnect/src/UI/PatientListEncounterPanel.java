...
public class PatientListEncounterPanel extends javax.swing.JPanel {

    /**
     * Creates new form PatientListEncounterPanel
     */
    EncounterInfo encData;
    DoctorInfo docData;
    UserInfo userData;
    String username;
    public PatientListEncounterPanel(String username) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for(Encounter obj : encData.getEncounterInfoFromDbForPatient(username, "encounter")){
