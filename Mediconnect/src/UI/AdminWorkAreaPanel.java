...
import UI.MediconnectLoginPanel;
import UI.HospitalManagementPanel;
import UI.UserCreatePanel;
import UI.UserWorkAreaPanel;
...
public class AdminWorkAreaPanel extends javax.swing.JPanel {
    ...
    public AdminWorkAreaPanel(UserInfo userInfo, HospitalInfo hosInfo, pharmacyInfo pharmInfo, SupplierInfo suppInfo) {
        initComponents();
...
//            row[3] = us.getDob();
    ...
    private void loadInsuranceData() {
        ...
        for (InsuranceAgency insurance : insuranceData.getInsuranceAgencyInfoFromDb()) {
...
//            row[1] = insurance.getCity();
    ...
    private void initComponents() {
        ...
        ManageUserJPanel.setBackground(new java.awt.Color(4, 133, 129));
        ...
        ManageHospitalJPanel.setBackground(new java.awt.Color(4, 133, 129));
        ...
        ManagePharmacyJPanel.setBackground(new java.awt.Color(4, 133, 129));
        ...
        lblRegPharmacy.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        ...
        ManageInsuranceJPanel.setBackground(new java.awt.Color(4, 133, 129));
        ...
        lblRegisterIns.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        ...
        ManageSupplierJPanel.setBackground(new java.awt.Color(4, 133, 129));
        ...
        lblRegSupplier.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
